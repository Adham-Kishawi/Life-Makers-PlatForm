...
return [
    ...
    'resource' => [
        'table' => [
            'class' => \App\Filament\Resources\UserResource\Table\UserTable::class,
            'filters' => \App\Filament\Resources\UserResource\Table\UserFilters::class,
            'actions' => \App\Filament\Resources\UserResource\Table\UserActions::class,
            'bulkActions' => \App\Filament\Resources\UserResource\Table\UserBulkActions::class,
        ],
        'form' => [
